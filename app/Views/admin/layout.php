...
<body class="bg-gray-200 text-black font-mono min-h-screen flex">

<div class="flex min-h-screen w-full">

    <!-- SIDEBAR -->
    <aside class="w-64 flex-shrink-0 bg-white border-r-4 border-black flex flex-col min-h-screen z-40">
        <div class="px-6 py-5 border-b-4 border-black bg-blue-600 text-white">
        ...
        <nav class="flex-1 px-4 py-6 space-y-4 font-bold uppercase text-sm">
        ...
        <div class="px-4 py-6 border-t-4 border-black space-y-4 font-bold uppercase text-xs">
            <a href="<?= base_url('/') ?>"
    ...
    <!-- KONTEN UTAMA -->
    <!-- Memberikan margin left sebesar sidebar (w-64 = 16rem = 256px) agar konten tidak tertutup -->
