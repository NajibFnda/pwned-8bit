    ...
    <div class="bg-white p-8 border-4 border-black w-full max-w-md shadow-[8px_8px_0px_rgba(255,255,255,1)]">
        ...
        <div class="mt-8 text-center text-xs text-gray-500 border-t-2 border-dashed border-gray-400 pt-6 space-y-4 font-bold uppercase">
            <div>
                ...
                <a href="<?= base_url('register') ?>" class="inline-block mt-2 text-blue-600 hover:bg-blue-600 hover:text-white px-2 py-1">Register now</a>
            </div>
            <div>
                <a href="<?= base_url('/') ?>" class="inline-block hover:bg-gray-200 text-gray-600 px-2 py-1">< BACK TO HOME</a>
            </div>
        </div>
